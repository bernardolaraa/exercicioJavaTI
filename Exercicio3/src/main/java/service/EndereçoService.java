...
public class EndereçoService {
	...
	private EndereçoDAO produtoDAO = new EndereçoDAO();
	private String form;
	...
	public EndereçoService() {
		makeForm();
	}

	
	public void makeForm() {
		makeForm(FORM_INSERT, new Endereço(), FORM_ORDERBY_DESCRICAO);
	}

	
	public void makeForm(int orderBy) {
		makeForm(FORM_INSERT, new Endereço(), orderBy);
	}

	
	public void makeForm(int tipo, Endereço produto, int orderBy) {
	...
	public Object insert(Request request, Response response) {
		...
		Endereço produto = new Endereço(-1, descricao, preco, quantidade, dataFabricacao, dataValidade);
	...
	public Object get(Request request, Response response) {
		...
		Endereço produto = (Endereço) produtoDAO.get(id);
	...
	public Object update(Request request, Response response) {
        int id = Integer.parseInt(request.params(":id"));
		Endereço produto = produtoDAO.get(id);
        String resp = "";       
